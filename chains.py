...
class Chain:
    def __init__(self):
        self.llm = None  # Don't initialize yet
    ...
    def extract_jobs(self, cleaned_text):
        self._init_llm()  # Initialize LLM lazily
    ...
    def extract_skills(self, text):
        ...
        prompt_extract_skills = PromptTemplate.from_template(
            ...
            {text}
            ### INSTRUCTION:
            Extract technical skills and programming languages as comma-separated list.
            """
        )
    ...
    def write_mail(self, job, links):
        ...
        prompt_email = PromptTemplate.from_template(
            ...
            {job_description}
            ### INSTRUCTION:
            Write a professional cold email matching the job.
            Return only the email in proper format.
            """
        )
